# ============================================================================
# SIT Environment - Lex Bot Configuration
# ============================================================================
# This file deploys a Lex bot to the SIT (System Integration Testing) environment.
#
# To switch bots:
...
# Lex Bot Module
# ============================================================================
# Instantiates the reusable Lex bot module with SIT environment configuration.
